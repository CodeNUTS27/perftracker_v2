...
import { FaPaperPlane, FaShoppingCart, FaUsers } from 'react-icons/fa';
import { BiMessageCheck, BiColorFill, BiSolidDashboard, BiCart } from 'react-icons/bi';
...
export const barSalesSeries = [
  {
    dataSource: barSalesData[0],
    xName: 'x',
    yName: 'y',
    name: 'Sales Revenue Amount',
    type: 'Column',
    marker: {
      dataLabel: {
        visible: true,
...
export const commissionsGrid = [
  {
    field: 'CommissionID',
    headerText: 'CommissionID',
    width: '150',
...
export const resellerData=[
  {
    Reseller: 'Michelle Alyson Fuentes'
  },
  {
    Reseller: 'Christian Angelo Silva'
  },
  {
    Reseller: 'Daniela Ligutan'
  },
  {
    Reseller: 'Romnick Canonigo'
  },
  {
    Reseller: 'Mark Tahimik'
  },
]
...
export const ordersData = [
  {
    ...
    Color: [' Brown', ' Black'],
    Design: 'Oak-wood design',
    Size: 'M',
    Stocks: 2,

    TotalAmount: 32.38,
    OrderItems: 'Wooden Table',
    Location: 'Makati',
    Status: 'pending',
    StatusBg: '#FB9678',
    ProductImage:
  ...
  },
  {
    ...
    Category: 'Furniture Item',
    Color: [' White', ' Black'],
    Design: 'Mahogany-wood design',
    Size: 'L',
    Stocks: 7,

    TotalAmount: 56.34,
    OrderItems: 'Wooden Chair',
    Location: 'Delhi',
    Status: 'complete',
    StatusBg: '#8BE78B',
    ProductImage:
  ...
  },
  {
    ...
    TotalAmount: 93.31,
    OrderItems: 'Dining Table w/ 4 Chairs',
    Location: 'New York',
    Status: 'active',
    StatusBg: '#03C9D7',
    ProductImage:
  ...
  },
  {
    ...
    Design: 'Red-wood design',
    Size: 'XL',
    Stocks: 10,

    TotalAmount: 93.31,
    OrderItems: 'Special Dining Table w/ 4 Chairs',
    Location: 'Germany',
    Status: 'canceled',
    StatusBg: '#FF5C8E',
    ProductImage:
...
export const pieChartData = [
  { x: 'Dining Table & Chair/Stools', y: 18, text: '18%' },
  { x: 'Bar Table & Chair/Stools', y: 8, text: '8%' },
  { x: 'Table & Benches', y: 15, text: '15%' },
  { x: 'Round Table & Round Chair/Stools', y: 11, text: '11%' },
  { x: 'Counter Table', y: 18, text: '18%' },
  { x: 'Japanese Table', y: 14, text: '14%' },
  { x: 'Others', y: 16, text: '16%' },
];
...
export const ecomPieChartData = [
  { x: 'Tables', y: 28, text: '35%' },
  { x: 'Chairs', y: 10, text: '15%' },
  { x: 'Cabinets', y: 18, text: '25%' },
  { x: 'Desks', y: 18, text: '25%' },
  { x: 'Tables', y: 28, text: '35%' },
  { x: 'Chairs', y: 10, text: '15%' },
  { x: 'Cabinets', y: 18, text: '25%' },
  { x: 'Desks', y: 18, text: '25%' },
